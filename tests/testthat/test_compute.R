...
#
#   captura_carbono_bosques(municipio = 'Córdoba', area_bosque = NULL)
#   captura_carbono_bosques(municipio = 'Córdoba', area_bosque = 500)
#   captura_carbono_bosques(municipio = 'Córdoba', area_bosque = 70, departamento = 'Nariño')
#   captura_carbono_bosques(municipio = 'Córdoba', area_bosque = NULL, departamento = 'Nariño')
# })
